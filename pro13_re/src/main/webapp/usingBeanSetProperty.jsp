...
%>
	...
	<jsp:setProperty name="vo" property="pwd" value='<%=request.getParameter("pwd")%>'/>
	<jsp:setProperty name="vo" property="name" param="name"/> //property와 param 똑같이 하면 value쓸 필요없이 간단함.
